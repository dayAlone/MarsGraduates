      ...
      <div class="elm">
        ...
        <div class="principles">
          ...
          <div class="item">
            ...
            <p>«Мы полностью используем наши ресурсы, не растрачиваемся попусту и занимаемся только тем, что можем делать очень хорошо».</p>
          </div>
          <div class="item">
            <?=svg('freedom')?>
          ...
          <div class="item">
            <div class="row">
              ...
              <div class="col-md-8 col-xs-8">
                ...
                <p>Сегодня в Mars в России и СНГ работает более <nobr>7 000</nobr> сотрудников, а по всему миру это число превышает отметку в 72 000.  Век спустя мы все также частный семейный бизнес, но масштабы у нас вполне галактические!</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="elm"><a name="brands" id="brands" class="anchor"></a>
        ...
        <div class="brands">
          ...
          <div class="item">
            ...
            <p>Wrigley со штаб-квартирой в Чикаго (штат Иллинойс, США) является одним из крупнейших в мире производителей жевательной резинки и сладостей. <br>В Wrigley работает более 17 000 сотрудников в 48 странах. </p>
          ...
          <div class="item">
            ...
            <p>Mars Food (штаб-квартира в Брюсселе, Бельгия) производит продукты питания в соответствии с местными традициями по всему миру.<br>В Mars Food работает более 1 700 сотрудников в 10 странах. </p>
